...
public class HorizonsModdedBiomeSliceProvider extends ModdedBiomeSliceProvider {
    ...
    private static final class HorizonsBiomeBuilder {
        ...
        private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, HorizonsBiomes.REDWOOD_FOREST.getKey()}, {VANILLA, VANILLA, VANILLA, VANILLA,VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
        private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{{VANILLA, null, VANILLA, null, null}, {null, null, null, null, HorizonsBiomes.REDWOOD_FOREST.getKey()}, {VANILLA, null, null, HorizonsBiomes.REDWOOD_FOREST.getKey(), null}, {null, null, VANILLA, VANILLA, VANILLA}, {null, null, null, null, null}};
        private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {HorizonsBiomes.REDBUD_GROVE.getKey(), HorizonsBiomes.REDBUD_GROVE.getKey(), VANILLA, VANILLA, HorizonsBiomes.REDWOOD_FOREST.getKey()}, {HorizonsBiomes.REDBUD_GROVE.getKey(), HorizonsBiomes.REDBUD_GROVE.getKey(), HorizonsBiomes.REDBUD_GROVE.getKey(), HorizonsBiomes.REDBUD_GROVE.getKey(), VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
        private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = new ResourceKey[][]{{VANILLA, null, null, null, null}, {null, null, HorizonsBiomes.REDBUD_GROVE.getKey(), HorizonsBiomes.REDBUD_GROVE.getKey(), HorizonsBiomes.REDWOOD_FOREST.getKey()}, {null, null, VANILLA, VANILLA, null}, {null, null, null, null, null}, {VANILLA, VANILLA, null, null, null}};

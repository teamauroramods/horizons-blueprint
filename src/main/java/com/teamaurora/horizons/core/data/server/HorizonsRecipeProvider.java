...
public class HorizonsRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        woodSet(HorizonsItemTags.REDWOOD_LOGS, HorizonsBlocks.REDWOOD_PLANKS.get(), HorizonsBlocks.REDWOOD_SLAB.get(), HorizonsBlocks.REDWOOD_STAIRS.get(), HorizonsBlocks.REDWOOD_LOG.get(), HorizonsBlocks.REDWOOD.get(), HorizonsBlocks.STRIPPED_REDWOOD_LOG.get(), HorizonsBlocks.STRIPPED_REDWOOD.get(), HorizonsItems.REDWOOD_BOATS.getFirst().get(),  HorizonsItems.REDWOOD_BOATS.getSecond().get(), HorizonsBlocks.REDWOOD_BUTTON.get(), HorizonsBlocks.REDWOOD_DOOR.get(), HorizonsBlocks.REDWOOD_TRAPDOOR.get(), HorizonsBlocks.REDWOOD_FENCE.get(), HorizonsBlocks.REDWOOD_FENCE_GATE.get(), HorizonsBlocks.REDWOOD_PRESSURE_PLATE.get(), HorizonsBlocks.REDWOOD_SIGNS.getFirst().get(), HorizonsBlocks.REDWOOD_VERTICAL_SLAB.get(), HorizonsBlocks.REDWOOD_POST.get(), HorizonsBlocks.STRIPPED_REDWOOD_POST.get(), HorizonsBlocks.REDWOOD_BOARDS.get(), HorizonsBlocks.REDWOOD_BEEHIVE.get(), HorizonsBlocks.REDWOOD_LADDER.get(), HorizonsBlocks.REDWOOD_BOOKSHELF.get(), HorizonsBlocks.REDWOOD_CHEST.get(), HorizonsBlocks.REDWOOD_TRAPPED_CHEST.get(), HorizonsItems.LARGE_REDWOOD_BOAT.get(), HorizonsItems.REDWOOD_FURNACE_BOAT.get(), HorizonsBlocks.VERTICAL_REDWOOD_PLANKS.get(), HorizonsBlocks.REDWOOD_CABINET.get(), consumer);
        woodSet(HorizonsItemTags.REDBUD_LOGS, HorizonsBlocks.REDBUD_PLANKS.get(), HorizonsBlocks.REDBUD_SLAB.get(), HorizonsBlocks.REDBUD_STAIRS.get(), HorizonsBlocks.REDBUD_LOG.get(), HorizonsBlocks.REDBUD_WOOD.get(), HorizonsBlocks.STRIPPED_REDBUD_LOG.get(), HorizonsBlocks.STRIPPED_REDBUD_WOOD.get(), HorizonsItems.REDBUD_BOATS.getFirst().get(),  HorizonsItems.REDBUD_BOATS.getSecond().get(), HorizonsBlocks.REDBUD_BUTTON.get(), HorizonsBlocks.REDBUD_DOOR.get(), HorizonsBlocks.REDBUD_TRAPDOOR.get(), HorizonsBlocks.REDBUD_FENCE.get(), HorizonsBlocks.REDBUD_FENCE_GATE.get(), HorizonsBlocks.REDBUD_PRESSURE_PLATE.get(), HorizonsBlocks.REDBUD_SIGNS.getFirst().get(), HorizonsBlocks.REDBUD_VERTICAL_SLAB.get(), HorizonsBlocks.REDBUD_POST.get(), HorizonsBlocks.STRIPPED_REDBUD_POST.get(), HorizonsBlocks.REDBUD_BOARDS.get(), HorizonsBlocks.REDBUD_BEEHIVE.get(), HorizonsBlocks.REDBUD_LADDER.get(), HorizonsBlocks.REDBUD_BOOKSHELF.get(), HorizonsBlocks.REDBUD_CHEST.get(), HorizonsBlocks.REDBUD_TRAPPED_CHEST.get(), HorizonsItems.LARGE_REDBUD_BOAT.get(), HorizonsItems.REDBUD_FURNACE_BOAT.get(), HorizonsBlocks.VERTICAL_REDBUD_PLANKS.get(), HorizonsBlocks.REDBUD_CABINET.get(), consumer);
        woodSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.JACARANDA_PLANKS.get(), HorizonsBlocks.JACARANDA_SLAB.get(), HorizonsBlocks.JACARANDA_STAIRS.get(), HorizonsBlocks.JACARANDA_LOG.get(), HorizonsBlocks.JACARANDA_WOOD.get(), HorizonsBlocks.STRIPPED_JACARANDA_LOG.get(), HorizonsBlocks.STRIPPED_JACARANDA_WOOD.get(), HorizonsItems.JACARANDA_BOATS.getFirst().get(),  HorizonsItems.JACARANDA_BOATS.getSecond().get(), HorizonsBlocks.JACARANDA_BUTTON.get(), HorizonsBlocks.JACARANDA_DOOR.get(), HorizonsBlocks.JACARANDA_TRAPDOOR.get(), HorizonsBlocks.JACARANDA_FENCE.get(), HorizonsBlocks.JACARANDA_FENCE_GATE.get(), HorizonsBlocks.JACARANDA_PRESSURE_PLATE.get(), HorizonsBlocks.JACARANDA_SIGNS.getFirst().get(), HorizonsBlocks.JACARANDA_VERTICAL_SLAB.get(), HorizonsBlocks.JACARANDA_POST.get(), HorizonsBlocks.STRIPPED_JACARANDA_POST.get(), HorizonsBlocks.JACARANDA_BOARDS.get(), HorizonsBlocks.JACARANDA_BEEHIVE.get(), HorizonsBlocks.JACARANDA_LADDER.get(), HorizonsBlocks.JACARANDA_BOOKSHELF.get(), HorizonsBlocks.JACARANDA_CHEST.get(), HorizonsBlocks.JACARANDA_TRAPPED_CHEST.get(), HorizonsItems.LARGE_JACARANDA_BOAT.get(), HorizonsItems.JACARANDA_FURNACE_BOAT.get(), HorizonsBlocks.VERTICAL_JACARANDA_PLANKS.get(), HorizonsBlocks.JACARANDA_CABINET.get(), consumer);
        ...
        leafSet(HorizonsItemTags.REDBUD_LOGS, HorizonsBlocks.REDBUD_LEAVES.get(), HorizonsBlocks.REDBUD_HEDGE.get(), HorizonsBlocks.REDBUD_LEAF_CARPET.get(), HorizonsBlocks.REDBUD_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.REDBUD_LOGS, HorizonsBlocks.BUDDING_REDBUD_LEAVES.get(), HorizonsBlocks.BUDDING_REDBUD_HEDGE.get(), HorizonsBlocks.BUDDING_REDBUD_LEAF_CARPET.get(), HorizonsBlocks.BUDDING_REDBUD_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.REDBUD_LOGS, HorizonsBlocks.FLOWERING_REDBUD_LEAVES.get(), HorizonsBlocks.FLOWERING_REDBUD_HEDGE.get(), HorizonsBlocks.FLOWERING_REDBUD_LEAF_CARPET.get(), HorizonsBlocks.FLOWERING_REDBUD_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.JACARANDA_LEAVES.get(), HorizonsBlocks.JACARANDA_HEDGE.get(), HorizonsBlocks.JACARANDA_LEAF_CARPET.get(), HorizonsBlocks.JACARANDA_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.BUDDING_JACARANDA_LEAVES.get(), HorizonsBlocks.BUDDING_JACARANDA_HEDGE.get(), HorizonsBlocks.BUDDING_JACARANDA_LEAF_CARPET.get(), HorizonsBlocks.BUDDING_JACARANDA_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.FLOWERING_JACARANDA_LEAVES.get(), HorizonsBlocks.FLOWERING_JACARANDA_HEDGE.get(), HorizonsBlocks.FLOWERING_JACARANDA_LEAF_CARPET.get(), HorizonsBlocks.FLOWERING_JACARANDA_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.AZURE_JACARANDA_LEAVES.get(), HorizonsBlocks.AZURE_JACARANDA_HEDGE.get(), HorizonsBlocks.AZURE_JACARANDA_LEAF_CARPET.get(), HorizonsBlocks.AZURE_JACARANDA_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.BUDDING_AZURE_JACARANDA_LEAVES.get(), HorizonsBlocks.BUDDING_AZURE_JACARANDA_HEDGE.get(), HorizonsBlocks.BUDDING_AZURE_JACARANDA_LEAF_CARPET.get(), HorizonsBlocks.BUDDING_AZURE_JACARANDA_LEAF_PILE.get(), consumer);
        leafSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.FLOWERING_AZURE_JACARANDA_LEAVES.get(), HorizonsBlocks.FLOWERING_AZURE_JACARANDA_HEDGE.get(), HorizonsBlocks.FLOWERING_AZURE_JACARANDA_LEAF_CARPET.get(), HorizonsBlocks.FLOWERING_AZURE_JACARANDA_LEAF_PILE.get(), consumer);
    ...
    private static void slab(ItemLike ingredient, ItemLike slab, String group, Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(slab, 6).group(group).define('#', ingredient).pattern("###").unlockedBy(getHasName(ingredient), has(ingredient)).save(consumer, getSaveLocation(slab));
    }

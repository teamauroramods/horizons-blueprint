...
public class HorizonsRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        leafSet(HorizonsItemTags.JACARANDA_LOGS, HorizonsBlocks.BLUE_JACARANDA_LEAVES.get(), HorizonsBlocks.BLUE_JACARANDA_HEDGE.get(), HorizonsBlocks.BLUE_JACARANDA_LEAF_CARPET.get(), HorizonsBlocks.BLUE_JACARANDA_LEAF_PILE.get(), consumer);

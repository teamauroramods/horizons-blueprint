...
public class HorizonsBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(HorizonsBlockTags.JACARANDA_LEAVES).add(HorizonsBlocks.JACARANDA_LEAVES.get(), HorizonsBlocks.BUDDING_JACARANDA_LEAVES.get(), HorizonsBlocks.FLOWERING_JACARANDA_LEAVES.get(), HorizonsBlocks.BLUE_JACARANDA_LEAVES.get(), HorizonsBlocks.BUDDING_BLUE_JACARANDA_LEAVES.get(), HorizonsBlocks.FLOWERING_BLUE_JACARANDA_LEAVES.get());
        ...
        this.tag(BlockTags.SAPLINGS).add(HorizonsBlocks.CYPRESS_SAPLING.get(), HorizonsBlocks.REDWOOD_SAPLING.get(), HorizonsBlocks.REDBUD_SAPLING.get(), HorizonsBlocks.FLOWERING_REDBUD_SAPLING.get(), HorizonsBlocks.JACARANDA_SAPLING.get(), HorizonsBlocks.BLUE_JACARANDA_SAPLING.get());
        ...
        this.tag(BlockTags.FLOWER_POTS).add(HorizonsBlocks.POTTED_CYPRESS_SAPLING.get(), HorizonsBlocks.POTTED_REDWOOD_SAPLING.get(), HorizonsBlocks.POTTED_REDBUD_SAPLING.get(), HorizonsBlocks.POTTED_FLOWERING_REDBUD_SAPLING.get(), HorizonsBlocks.POTTED_BLUE_LILY.get(), HorizonsBlocks.POTTED_LIGHT_GRAY_LILY.get(), HorizonsBlocks.POTTED_CYAN_LILY.get(), HorizonsBlocks.POTTED_LIGHT_BLUE_LILY.get(), HorizonsBlocks.POTTED_MAGENTA_LILY.get(), HorizonsBlocks.POTTED_PINK_LILY.get(), HorizonsBlocks.POTTED_PURPLE_LILY.get(), HorizonsBlocks.POTTED_WHITE_LILY.get(), HorizonsBlocks.POTTED_YELLOW_DAISY.get(), HorizonsBlocks.POTTED_RED_DAISY.get(), HorizonsBlocks.POTTED_PURPLE_DAISY.get(), HorizonsBlocks.POTTED_PINK_DAISY.get(), HorizonsBlocks.POTTED_ORANGE_DAISY.get(), HorizonsBlocks.POTTED_MAGENTA_DAISY.get(), HorizonsBlocks.POTTED_BLUE_DAISY.get(), HorizonsBlocks.POTTED_AMARANTHUS.get(), HorizonsBlocks.POTTED_MYOSOTIS.get());
        this.tag(BlockTags.SMALL_FLOWERS).add(HorizonsBlocks.BLUE_LILY.get(), HorizonsBlocks.LIGHT_GRAY_LILY.get(), HorizonsBlocks.CYAN_LILY.get(), HorizonsBlocks.LIGHT_BLUE_LILY.get(), HorizonsBlocks.MAGENTA_LILY.get(), HorizonsBlocks.PINK_LILY.get(), HorizonsBlocks.PURPLE_LILY.get(), HorizonsBlocks.WHITE_LILY.get(), HorizonsBlocks.YELLOW_DAISY.get(), HorizonsBlocks.RED_DAISY.get(), HorizonsBlocks.PURPLE_DAISY.get(), HorizonsBlocks.PINK_DAISY.get(), HorizonsBlocks.ORANGE_DAISY.get(), HorizonsBlocks.MAGENTA_DAISY.get(), HorizonsBlocks.BLUE_DAISY.get(), HorizonsBlocks.AMARANTHUS.get(), HorizonsBlocks.MYOSOTIS.get());

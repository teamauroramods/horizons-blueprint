...
public class HorizonsBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlueprintBlockTags.WOODEN_VERTICAL_SLABS).add(HorizonsBlocks.CYPRESS_VERTICAL_SLAB.get(), HorizonsBlocks.REDWOOD_VERTICAL_SLAB.get(), HorizonsBlocks.REDBUD_VERTICAL_SLAB.get());
        this.tag(BlueprintBlockTags.HEDGES).add(HorizonsBlocks.CYPRESS_HEDGE.get(), HorizonsBlocks.REDWOOD_HEDGE.get(), HorizonsBlocks.REDBUD_HEDGE.get(), HorizonsBlocks.BUDDING_REDBUD_HEDGE.get(), HorizonsBlocks.FLOWERING_REDBUD_HEDGE.get());
        this.tag(BlueprintBlockTags.LADDERS).add(HorizonsBlocks.CYPRESS_LADDER.get(), HorizonsBlocks.REDWOOD_LADDER.get(), HorizonsBlocks.REDBUD_LADDER.get());

        //woodworks
        this.tag(BlueprintBlockTags.LEAF_PILES).add(HorizonsBlocks.CYPRESS_LEAF_PILE.get(), HorizonsBlocks.REDWOOD_LEAF_PILE.get(), HorizonsBlocks.REDBUD_LEAF_PILE.get());

        //forge
        this.tag(Tags.Blocks.CHESTS_WOODEN).add(HorizonsBlocks.CYPRESS_CHEST.get(), HorizonsBlocks.CYPRESS_TRAPPED_CHEST.get(), HorizonsBlocks.REDWOOD_CHEST.get(), HorizonsBlocks.REDWOOD_TRAPPED_CHEST.get(), HorizonsBlocks.REDBUD_CHEST.get(), HorizonsBlocks.REDBUD_TRAPPED_CHEST.get());
        this.tag(Tags.Blocks.CHESTS_TRAPPED).add(HorizonsBlocks.CYPRESS_TRAPPED_CHEST.get(), HorizonsBlocks.REDWOOD_TRAPPED_CHEST.get(), HorizonsBlocks.REDBUD_TRAPPED_CHEST.get());
        ...
        this.tag(BlockTags.BEEHIVES).add(HorizonsBlocks.CYPRESS_BEEHIVE.get(), HorizonsBlocks.REDWOOD_BEEHIVE.get(), HorizonsBlocks.REDBUD_BEEHIVE.get());
        this.tag(BlockTags.WOODEN_BUTTONS).add(HorizonsBlocks.CYPRESS_BUTTON.get(), HorizonsBlocks.REDWOOD_BUTTON.get(), HorizonsBlocks.REDBUD_BUTTON.get());
        this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(HorizonsBlocks.CYPRESS_PRESSURE_PLATE.get(), HorizonsBlocks.REDWOOD_PRESSURE_PLATE.get(), HorizonsBlocks.REDBUD_PRESSURE_PLATE.get());
        this.tag(BlockTags.PLANKS).add(HorizonsBlocks.CYPRESS_PLANKS.get(), HorizonsBlocks.VERTICAL_CYPRESS_PLANKS.get(), HorizonsBlocks.REDWOOD_PLANKS.get(), HorizonsBlocks.VERTICAL_REDWOOD_PLANKS.get(), HorizonsBlocks.REDBUD_PLANKS.get(), HorizonsBlocks.VERTICAL_REDBUD_PLANKS.get());
        this.tag(BlockTags.WOODEN_DOORS).add(HorizonsBlocks.CYPRESS_DOOR.get(), HorizonsBlocks.REDWOOD_DOOR.get(), HorizonsBlocks.REDBUD_DOOR.get());
        this.tag(BlockTags.WOODEN_TRAPDOORS).add(HorizonsBlocks.CYPRESS_TRAPDOOR.get(), HorizonsBlocks.REDWOOD_TRAPDOOR.get(), HorizonsBlocks.REDBUD_TRAPDOOR.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(HorizonsBlocks.CYPRESS_STAIRS.get(), HorizonsBlocks.REDWOOD_STAIRS.get(), HorizonsBlocks.REDBUD_STAIRS.get());
        this.tag(BlockTags.WOODEN_SLABS).add(HorizonsBlocks.CYPRESS_SLAB.get(), HorizonsBlocks.REDWOOD_SLAB.get(), HorizonsBlocks.REDBUD_SLAB.get());
        this.tag(BlockTags.WALL_SIGNS).add(HorizonsBlocks.CYPRESS_SIGNS.getSecond().get(), HorizonsBlocks.REDWOOD_SIGNS.getSecond().get(), HorizonsBlocks.REDBUD_SIGNS.getSecond().get());
        this.tag(BlockTags.STANDING_SIGNS).add(HorizonsBlocks.CYPRESS_SIGNS.getFirst().get(), HorizonsBlocks.REDWOOD_SIGNS.getFirst().get(), HorizonsBlocks.REDBUD_SIGNS.getFirst().get());
        this.tag(BlockTags.WOODEN_FENCES).add(HorizonsBlocks.CYPRESS_FENCE.get(), HorizonsBlocks.REDWOOD_FENCE.get(), HorizonsBlocks.REDBUD_FENCE_GATE.get());
        this.tag(BlockTags.LOGS_THAT_BURN).addTag(HorizonsBlockTags.CYPRESS_LOGS).addTag(HorizonsBlockTags.REDWOOD_LOGS).addTag(HorizonsBlockTags.REDBUD_LOGS);
        this.tag(BlockTags.LEAVES).addTag(HorizonsBlockTags.CYPRESS_LEAVES).addTag(HorizonsBlockTags.REDWOOD_LEAVES).addTag(HorizonsBlockTags.REDBUD_LEAVES);
        this.tag(BlockTags.CLIMBABLE).add(HorizonsBlocks.CYPRESS_LADDER.get(), HorizonsBlocks.BEARD_MOSS.get(), HorizonsBlocks.REDWOOD_LADDER.get(), HorizonsBlocks.REDBUD_LADDER.get());
        this.tag(BlockTags.FENCE_GATES).add(HorizonsBlocks.CYPRESS_FENCE_GATE.get(), HorizonsBlocks.REDWOOD_FENCE_GATE.get(), HorizonsBlocks.REDBUD_FENCE_GATE.get());
        this.tag(BlockTags.SAPLINGS).add(HorizonsBlocks.CYPRESS_SAPLING.get(), HorizonsBlocks.REDWOOD_SAPLING.get(), HorizonsBlocks.REDBUD_SAPLING.get(), HorizonsBlocks.BUDDING_REDBUD_SAPLING.get(), HorizonsBlocks.FLOWERING_REDBUD_SAPLING.get());
        this.tag(BlockTags.REPLACEABLE_PLANTS).add(HorizonsBlocks.GIANT_FERN.get());
        this.tag(BlockTags.FLOWER_POTS).add(HorizonsBlocks.POTTED_CYPRESS_SAPLING.get(), HorizonsBlocks.POTTED_REDWOOD_SAPLING.get(), HorizonsBlocks.POTTED_REDBUD_SAPLING.get(), HorizonsBlocks.POTTED_BUDDING_REDBUD_SAPLING.get(), HorizonsBlocks.POTTED_FLOWERING_REDBUD_SAPLING.get(), HorizonsBlocks.POTTED_BLUE_LILY.get(), HorizonsBlocks.POTTED_LIGHT_GRAY_LILY.get(), HorizonsBlocks.POTTED_CYAN_LILY.get(), HorizonsBlocks.POTTED_LIGHT_BLUE_LILY.get(), HorizonsBlocks.POTTED_MAGENTA_LILY.get(), HorizonsBlocks.POTTED_PINK_LILY.get(), HorizonsBlocks.POTTED_PURPLE_LILY.get(), HorizonsBlocks.POTTED_WHITE_LILY.get(), HorizonsBlocks.POTTED_YELLOW_DAISY.get(), HorizonsBlocks.POTTED_RED_DAISY.get(), HorizonsBlocks.POTTED_PURPLE_DAISY.get(), HorizonsBlocks.POTTED_PINK_DAISY.get(), HorizonsBlocks.POTTED_ORANGE_DAISY.get(), HorizonsBlocks.POTTED_MAGENTA_DAISY.get(), HorizonsBlocks.POTTED_BLUE_DAISY.get());
        this.tag(BlockTags.SMALL_FLOWERS).add(HorizonsBlocks.BLUE_LILY.get(), HorizonsBlocks.LIGHT_GRAY_LILY.get(), HorizonsBlocks.CYAN_LILY.get(), HorizonsBlocks.LIGHT_BLUE_LILY.get(), HorizonsBlocks.MAGENTA_LILY.get(), HorizonsBlocks.PINK_LILY.get(), HorizonsBlocks.PURPLE_LILY.get(), HorizonsBlocks.WHITE_LILY.get(), HorizonsBlocks.YELLOW_DAISY.get(), HorizonsBlocks.RED_DAISY.get(), HorizonsBlocks.PURPLE_DAISY.get(), HorizonsBlocks.PINK_DAISY.get(), HorizonsBlocks.ORANGE_DAISY.get(), HorizonsBlocks.MAGENTA_DAISY.get(), HorizonsBlocks.BLUE_DAISY.get());

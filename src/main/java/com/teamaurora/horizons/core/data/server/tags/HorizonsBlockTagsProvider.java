...
public class HorizonsBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.SAPLINGS).add(HorizonsBlocks.CYPRESS_SAPLING.get(), HorizonsBlocks.REDWOOD_SAPLING.get(), HorizonsBlocks.REDBUD_SAPLING.get(), HorizonsBlocks.BUDDING_REDBUD_SAPLING.get(), HorizonsBlocks.FLOWERING_REDBUD_SAPLING.get(), HorizonsBlocks.JACARANDA_SAPLING.get(), HorizonsBlocks.BLUE_JACARANDA_SAPLING.get());

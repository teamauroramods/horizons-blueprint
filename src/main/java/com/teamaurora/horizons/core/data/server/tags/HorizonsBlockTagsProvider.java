...
public class HorizonsBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.FLOWER_POTS).add(HorizonsBlocks.POTTED_CYPRESS_SAPLING.get(), HorizonsBlocks.POTTED_REDWOOD_SAPLING.get(), HorizonsBlocks.POTTED_REDBUD_SAPLING.get(), HorizonsBlocks.POTTED_FLOWERING_REDBUD_SAPLING.get(), HorizonsBlocks.POTTED_BLUE_LILY.get(), HorizonsBlocks.POTTED_LIGHT_GRAY_LILY.get(), HorizonsBlocks.POTTED_CYAN_LILY.get(), HorizonsBlocks.POTTED_LIGHT_BLUE_LILY.get(), HorizonsBlocks.POTTED_MAGENTA_LILY.get(), HorizonsBlocks.POTTED_PINK_LILY.get(), HorizonsBlocks.POTTED_PURPLE_LILY.get(), HorizonsBlocks.POTTED_WHITE_LILY.get(), HorizonsBlocks.POTTED_YELLOW_DAISY.get(), HorizonsBlocks.POTTED_RED_DAISY.get(), HorizonsBlocks.POTTED_PURPLE_DAISY.get(), HorizonsBlocks.POTTED_PINK_DAISY.get(), HorizonsBlocks.POTTED_ORANGE_DAISY.get(), HorizonsBlocks.POTTED_MAGENTA_DAISY.get(), HorizonsBlocks.POTTED_BLUE_DAISY.get());

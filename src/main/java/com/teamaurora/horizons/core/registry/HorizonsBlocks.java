...
import com.teamaurora.horizons.common.levelgen.tree.FloweringRedbudTreeGrower;
import com.teamaurora.horizons.common.levelgen.tree.RedbudTreeGrower;
...
public class HorizonsBlocks {
    ...
    public static final RegistryObject<Block> REDBUD_SAPLING = HELPER.createBlock("redbud_sapling", () -> new BlueprintSaplingBlock(new RedbudTreeGrower(), PropertyUtil.sapling()), CreativeModeTab.TAB_DECORATIONS);
    ...
    public static final RegistryObject<Block> FLOWERING_REDBUD_SAPLING = HELPER.createBlock("flowering_redbud_sapling", () -> new BlueprintSaplingBlock(new FloweringRedbudTreeGrower(), PropertyUtil.sapling()), CreativeModeTab.TAB_DECORATIONS);
    ...
    public static final RegistryObject<Block> AZURE_JACARANDA_SAPLING = HELPER.createBlock("azure_jacaranda_sapling", () -> new BlueprintSaplingBlock(new OakTreeGrower(), PropertyUtil.sapling()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> POTTED_AZURE_JACARANDA_SAPLING = HELPER.createBlockNoItem("potted_azure_jacaranda_sapling", () -> new FlowerPotBlock(AZURE_JACARANDA_SAPLING.get(), PropertyUtil.flowerPot()));
    ...
    public static final RegistryObject<Block> AZURE_JACARANDA_LEAVES = HELPER.createBlock("azure_jacaranda_leaves", () -> new BlueprintLeavesBlock(HorizonsProperties.JACARANDA.leaves()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> BUDDING_AZURE_JACARANDA_LEAVES = HELPER.createBlock("budding_azure_jacaranda_leaves", () -> new BlueprintLeavesBlock(HorizonsProperties.JACARANDA.leaves()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> FLOWERING_AZURE_JACARANDA_LEAVES = HELPER.createBlock("flowering_azure_jacaranda_leaves", () -> new BlueprintLeavesBlock(HorizonsProperties.JACARANDA.leaves()), CreativeModeTab.TAB_DECORATIONS);
    ...
    public static final RegistryObject<Block> AZURE_JACARANDA_HEDGE = HELPER.createCompatFuelBlock(HorizonsConstants.QUARK, "azure_jacaranda_hedge", () -> new HedgeBlock(HorizonsProperties.JACARANDA.planks()), 300, CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> AZURE_JACARANDA_LEAF_CARPET = HELPER.createCompatBlock(HorizonsConstants.QUARK, "azure_jacaranda_leaf_carpet", () -> new LeafCarpetBlock(HorizonsProperties.JACARANDA.leafCarpet()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> AZURE_JACARANDA_LEAF_PILE = HELPER.createCompatBlock(HorizonsConstants.WOODWORKS, "azure_jacaranda_leaf_pile", () -> new LeafPileBlock(HorizonsProperties.JACARANDA.leafPile()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> BUDDING_AZURE_JACARANDA_HEDGE = HELPER.createCompatFuelBlock(HorizonsConstants.QUARK, "budding_azure_jacaranda_hedge", () -> new HedgeBlock(HorizonsProperties.JACARANDA.planks()), 300, CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> BUDDING_AZURE_JACARANDA_LEAF_CARPET = HELPER.createCompatBlock(HorizonsConstants.QUARK, "budding_azure_jacaranda_leaf_carpet", () -> new LeafCarpetBlock(HorizonsProperties.JACARANDA.leafCarpet()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> BUDDING_AZURE_JACARANDA_LEAF_PILE = HELPER.createCompatBlock(HorizonsConstants.WOODWORKS, "budding_azure_jacaranda_leaf_pile", () -> new LeafPileBlock(HorizonsProperties.JACARANDA.leafPile()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> FLOWERING_AZURE_JACARANDA_HEDGE = HELPER.createCompatFuelBlock(HorizonsConstants.QUARK, "flowering_azure_jacaranda_hedge", () -> new HedgeBlock(HorizonsProperties.JACARANDA.planks()), 300, CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> FLOWERING_AZURE_JACARANDA_LEAF_CARPET = HELPER.createCompatBlock(HorizonsConstants.QUARK, "flowering_azure_jacaranda_leaf_carpet", () -> new LeafCarpetBlock(HorizonsProperties.JACARANDA.leafCarpet()), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> FLOWERING_AZURE_JACARANDA_LEAF_PILE = HELPER.createCompatBlock(HorizonsConstants.WOODWORKS, "flowering_azure_jacaranda_leaf_pile", () -> new LeafPileBlock(HorizonsProperties.JACARANDA.leafPile()), CreativeModeTab.TAB_DECORATIONS);

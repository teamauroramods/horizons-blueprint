...
public class HorizonsBlocks {
    ...
    public static final RegistryObject<Block> POTTED_BLUE_JACARANDA_SAPLING = HELPER.createBlockNoItem("potted_blue_jacaranda_sapling", () -> new FlowerPotBlock(JACARANDA_SAPLING.get(), PropertyUtil.flowerPot()));
